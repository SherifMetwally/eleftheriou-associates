...
export default function AboutPage() {
  return (
    <>
      <PageHero
        eyebrow="Since 2001 · Alexandria · Athens"
        title="Independent counsel across a region of 450 million consumers."
      ...
      >
        Eleftheriou Associates is a consultancy operating in Egypt since 2001,
        covering Mediterranean Europe, North Africa, the Mideast, and the Arab
        Gulf. We advise organisations in the public and private sectors — then
        stay to execute.
      </PageHero>
